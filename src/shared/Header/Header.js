...
import logo from "../../assets/logo/navbarlog.png";
...
const Header = () => {
  ...
  return (
    <nav className="relative bg-white shadow  shadow-[#319795] ">
      <div className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        ...
        >
          <div className="flex flex-col md:flex-row md:mx-6">
            ...
            <Link
              className="my-2 text-[#319795] transition-colors duration-300 transform text-[15px]    md:mx-4 md:my-0"
              href="#"
            >
              Logout
            </Link>
